...
export default function About() {
  return (
    <div className="min-h-screen bg-gray-900">
      ...
      {/* Back Button */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 bg-gray-900">
        <Link href="/">
      ...
      <section className="py-20 bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-4xl mx-auto">
              ...
              <h2 className="text-xl md:text-2xl font-semibold text-primary mb-6">About Us</h2>
              ...
              <div className="space-y-5">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-white mb-3">Our Goal</h3>
                ...
                <div>
                  <h3 className="text-xl font-semibold text-white mb-3">About Our Founder & Managing Director – Mr. Mahesh Asnani</h3>
                  <p className="text-gray-300 leading-relaxed mb-3">
                  ...
                  <ul className="list-disc pl-5 space-y-2 text-gray-300 mb-3">
